    ...
    for epoch in range(1000000):  # keep running
        ...
        for i, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['checkpoint_print'] == 0 and opt['rank'] == 0:
                ...
                logger.info(message)
                # Simple wandb logging - just the losses and learning rate
            ...
            if current_step % opt['train']['checkpoint_test'] == 0 and opt['rank'] == 0:
                ...
                for test_data in test_loader:
                   ...
                   # This line outputs the pnsr obtained for each image for every val 
        ...
        logger.info('Epoch {:3d} finished, time: {:.2f}s, iter:{:8,d}'.format(epoch, epoch_time, current_step))
